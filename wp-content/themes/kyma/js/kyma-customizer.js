(function ($) {
    ...
    if ('undefined' !== typeof kyma_button) {
        /* Customizer Buttons */
        $('.wp-full-overlay-sidebar-content').prepend('<a style="width: 80%; background-color:#02b7b7; color: #fff; margin: 10px auto 5px auto; display: block; text-align: center;" href="http://www.demo.webhuntinfotech.com/demo#kyma_advanced" class="button" target="_blank">' + kyma_button.pro + '</a>');
